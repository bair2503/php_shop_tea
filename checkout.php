...
<body>
	...
	$total_products = $_POST['total_product'];
	$delivery_address = $_POST['address'];
	$total_amount = $_POST['total_amount'];

	$query = "INSERT INTO orders_info (data_orders, user_id, status_order, total_products, delivery_address, total_amount)
          VALUES ('$timestamp', {$_COOKIE['id']}, '1', '$total_products', '$delivery_address', '$total_amount')";
	echo $query;
						...
						<div class="cart_extra_content cart_extra_total">
							...
							<ul class="cart_extra_total_list">
								<li class="d-flex flex-row align-items-center justify-content-start">
									...
									<div class="cart_extra_total_value ml-auto"><?php echo $_POST['total_product']; ?> шт</div>
								</li>
								<li class="d-flex flex-row align-items-center justify-content-start">
								...
								<li class="d-flex flex-row align-items-center justify-content-start">
									...
									<div class="cart_extra_total_value ml-auto"><?php echo $_POST['total_amount']; ?> руб</div>
								</li>
							</ul>
